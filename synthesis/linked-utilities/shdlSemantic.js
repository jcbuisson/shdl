...
import { replaceAliases, getOriginalEquipotentialIndex, signalCompoundArity, signalCompoundAtIndex, sumoftermsCompoundAtIndex,
   ...
   argumentArity, argumentAt, parameterArity, parameterNameAtIndex } from './shdlUtilities.js';
...
export function collectEquipotentials(moduleName, name2module) {
...
export function checkIOStatus(module) {
